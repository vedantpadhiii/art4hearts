...
const chaptersData = [
  ...
  { name: 'Art4Hearts Crest High School', leader: 'Mallory Bowen (12)', location: 'Shelby', region: 'North Carolina', country: 'USA', email: 'mallorybowen2022@gmail.com', lat: 35.2790, lng: -81.6381 },
  { name: 'Art4Hearts Lebanon High School', leader: 'Addy Wright (12)', location: 'Lebanon', region: 'Indiana', country: 'USA', email: 'theaddisonwright@gmail.com', lat: 40.0423, lng: -86.4656 },
  { name: 'Art4Hearts Palm Beach Gardens', leader: 'Keira Compiani (10)', location: 'Palm Beach Gardens', region: 'Florida', country: 'USA', email: 'Kmae.compiani@gmail.com', lat: 26.8158, lng: -80.1065 },
  { name: 'Art4Hearts Suffolk County Long Island', leader: 'Aishwarya Kammili (11)', location: 'Suffolk', region: 'New York', country: 'USA', email: 'aishwaryakammili@gmail.com', lat: 40.9176, lng: -72.7554 },
  { name: 'Art4Hearts Bridgewater', leader: 'Neila Roach (11)', location: 'Bridgewater', region: 'Massachusetts', country: 'USA', email: 'roachneila21@gmail.com', lat: 41.9813, lng: -71.0084 },
  { name: 'Art4Hearts Frontier International Academy', leader: 'Noor Ahmed (10)', location: 'Hamtramck', region: 'Michigan', country: 'USA', email: 'zaralovescats143@gmail.com', lat: 42.2324, lng: -83.0673 },
  { name: 'Art4Hearts West Campus High School', leader: 'Janey Saechao (10)', location: 'Sacramento', region: 'California', country: 'USA', email: 'art4heartswchs@gmail.com', lat: 38.5816, lng: -121.4944 },
  { name: 'Art4Hearts Atherton High School', leader: 'Delaney Payton (11)', location: 'Louisville', region: 'Kentucky', country: 'USA', email: 'art4heartsahs@gmail.com', lat: 38.2527, lng: -85.7585 },
  { name: 'Art4Hearts Apple Valley High School', leader: 'Marley Fic (12)', location: 'Apple Valley', region: 'California', country: 'USA', email: '2026.marleyfic@gmail.com', lat: 34.5001, lng: -117.1812 },
  ...
  { name: 'Art4Hearts Denver', leader: 'Ellie Carroll (11)', location: 'Denver', region: 'Colorado', country: 'USA', email: 'Elliecarrolladvocacy@gmail.com', lat: 39.7392, lng: -104.9903 },
  { name: 'Art4Hearts Gilbert Classical Academy', leader: 'Sophie Kephart (11)', location: 'Gilbert', region: 'Arizona', country: 'USA', email: 'sophiegkephart@gmail.com', lat: 33.3528, lng: -111.7890 },
  { name: 'Art4Hearts Milpitas Middle College High School', leader: 'Nishka Gohel (11)', location: 'Milpitas', region: 'California', country: 'USA', email: 'nishkangohel@gmail.com', lat: 37.4281, lng: -121.8863 },
  { name: 'Art4Hearts Clear Creek High School', leader: 'Hafsa Syed (11)', location: 'League City', region: 'Texas', country: 'USA', email: 'Hafsasyed009@gmail.com', lat: 29.4849, lng: -95.1181 },
  { name: 'Art4Hearts SEA', leader: 'Selene Maldonado (10)', location: 'Ormond Beach', region: 'Florida', country: 'USA', email: 'selene0925@icloud.com', lat: 29.2876, lng: -81.0573 },
  ...
  { name: 'Art4Hearts Emerson High School', leader: 'Andrea Capati (11)', location: 'McKinney', region: 'Texas', country: 'USA', email: 'andrealorin.capati.169@k12.friscoisd.org', lat: 33.1972, lng: -96.6397 },
  { name: 'Art4Hearts DH Conley HS', leader: 'Maddie Adrias (12)', location: 'Greenville', region: 'North Carolina', country: 'USA', email: 'art4hearts.dhc@gmail.com', lat: 35.6129, lng: -82.3982 },
  { name: 'Art4Hearts Medina, TN', leader: 'Payton Wilson (11)', location: 'Medina', region: 'Tennessee', country: 'USA', email: 'Paytonw680@outlook.com', lat: 35.4434, lng: -88.7162 },
  { name: 'Art4Hearts Miami, FL', leader: 'Melody Monge (11)', location: 'Miami', region: 'Florida', country: 'USA', email: 'melodymonge902@gmail.com', lat: 25.7617, lng: -80.1918 },
  { name: 'Art4Hearts Frisco, TX', leader: 'Khyathi Motukuri (11)', location: 'Frisco', region: 'Texas', country: 'USA', email: 'art4hearts.frisco@gmail.com', lat: 33.1506, lng: -96.8236 },
  { name: 'Art4Hearts Saddle River Day School', leader: 'Emma Ehrenkranz (12)', location: 'Saddle River', region: 'New Jersey', country: 'USA', email: 'emma.ehrenkranz@icloud.com', lat: 40.9616, lng: -74.0352 },
  { name: 'Art4Hearts Webber Academy', leader: 'Kylah Meghani (9)', location: 'Calgary', region: 'Alberta', country: 'Canada', email: 'art4heartswebber@gmail.com', lat: 51.0447, lng: -114.0719 },
  { name: 'Art4Hearts Saint Paul High School', leader: 'Ariana Soto (12)', location: 'Santa Fe Springs', region: 'California', country: 'USA', email: 'ariana335024@gmail.com', lat: 33.9453, lng: -118.0951 },
  { name: 'Art4Hearts Irvine High School', leader: 'Iman Rizvi (10)', location: 'Irvine', region: 'California', country: 'USA', email: 'arts4heartsihschapter@gmail.com', lat: 33.6846, lng: -117.8265 },
  { name: 'Art4Hearts Waxhaw, NC', leader: 'Shyna Jalota (10)', location: 'Waxhaw', region: 'North Carolina', country: 'USA', email: 'shyna.jalota13@gmail.com', lat: 34.8797, lng: -80.7483 },
  { name: 'Art4Hearts Hinesville, Georgia', leader: 'Kamilah Perez-Concepcion (10)', location: 'Hinesville', region: 'Georgia', country: 'USA', email: 'milahpc.09@gmail.com', lat: 31.8418, lng: -81.6200 },
  { name: 'Art4Hearts Strawberry Crest High School', leader: 'Nishita Moravineni (12)', location: 'Shelby', region: 'North Carolina', country: 'USA', email: 'art4heartsschs@gmail.com', lat: 35.2790, lng: -81.6381 },
  ...
  { name: 'Art4Hearts Florence High School', leader: 'Shaniyah Bailey', location: 'Florence', region: 'Alabama', country: 'USA', email: 'mayweather1547@gmail.com', lat: 34.1899, lng: -87.6772 },
  { name: 'Art4Hearts Communications High School', leader: 'Vicky Zheng', location: 'Wall Township', region: 'New Jersey', country: 'USA', email: 'vickyjadezheng@gmail.com', lat: 40.1717, lng: -74.1698 },
  { name: 'Art4Hearts Berkley High School', leader: 'Sophia Nelson', location: 'Berkley', region: 'Michigan', country: 'USA', email: 'brknelsons44@stu.berkleyschools.org', lat: 42.4870, lng: -83.2143 },
  { name: 'Art4Hearts Piscataway High School', leader: 'Ayesha Rafique', location: 'Piscataway', region: 'New Jersey', country: 'USA', email: 'rafiqueayesha248@gmail.com', lat: 40.5556, lng: -74.4626 },
  { name: 'Art4Hearts Highlands Ranch High School', leader: 'Kelsey Messmer', location: 'Highlands Ranch', region: 'Colorado', country: 'USA', email: 'spaceunicorn2414@gmail.com', lat: 39.5415, lng: -104.9838 },
  { name: 'Art4Hearts Framingham High School', leader: 'Camryn Parker', location: 'Framingham', region: 'Massachusetts', country: 'USA', email: 'alyssa2009hippo@gmail.com', lat: 42.2793, lng: -71.4148 },
  { name: 'Art4Hearts Dix Hills', leader: 'Ashley Alaimo', location: 'Dix Hills', region: 'New York', country: 'USA', email: 'ashleywatches3@gmail.com', lat: 40.8167, lng: -73.3500 },
  ...
  { name: 'Art4Hearts Hillsborough', leader: 'Harini Raghuraman', location: 'Hillsborough', region: 'New Jersey', country: 'USA', email: 'harrag129@gmail.com', lat: 40.5236, lng: -74.5990 },
  { name: 'Art4Hearts Seabreeze High School', leader: 'Faith Baldwin', location: 'Ormond Beach', region: 'Florida', country: 'USA', email: 'faithnbaldwin@gmail.com', lat: 29.2876, lng: -81.0573 },
  { name: 'Art4Hearts Venice High School', leader: 'Amy Nguyen', location: 'Osprey', region: 'Florida', country: 'USA', email: 'amykim271@gmail.com', lat: 27.0895, lng: -82.4554 },
  { name: 'Art4Hearts Kentfield', leader: 'Emily Goldman', location: 'Kentfield', region: 'California', country: 'USA', email: 'emily.grey@gmail.com', lat: 37.9667, lng: -122.5500 },
  { name: 'Art4Hearts Whittier', leader: 'Mia Oliden', location: 'Whittier', region: 'California', country: 'USA', email: 'art4hearts.whittier@gmail.com', lat: 33.9793, lng: -118.0326 },
  { name: 'Art4Hearts Monterey Trail High School', leader: 'Audrey Nguyen', location: 'Elk Grove', region: 'California', country: 'USA', email: 'audreynguyensln@gmail.com', lat: 38.4161, lng: -121.3913 },
  { name: 'Art4Hearts Archie Williams High School', leader: 'Amelia Driver', location: 'San Anselmo', region: 'California', country: 'USA', email: 'ameliajdriver@gmail.com', lat: 37.9833, lng: -122.5667 },
  { name: 'Art4Hearts Lynn', leader: 'Isabella Vidinha', location: 'Lynn', region: 'Massachusetts', country: 'USA', email: 'isabellavidinha15@gmail.com', lat: 42.4686, lng: -71.0096 },
  ...
  { name: 'Art4Hearts Kalama', leader: 'Ayva Taylor', location: 'Kalama', region: 'Washington', country: 'USA', email: 'ayva.b.taylor@gmail.com', lat: 46.0050, lng: -122.8397 },
  { name: 'Art4Hearts St Marys Catholic School', leader: 'Georgia Rethlake', location: 'Taylor', region: 'Texas', country: 'USA', email: 'georgia.rethlake@gmail.com', lat: 29.3669, lng: -95.3606 },
  ...
  { name: 'Art4Hearts Ocoee, Florida', leader: 'Mariola Matta', location: 'Ocoee', region: 'Florida', country: 'USA', email: 'art4heartsorg@gmail.com', lat: 28.6025, lng: -81.6001 },
  ...
  { name: 'Art4Hearts Prospect High School', leader: 'Lucia Peshek', location: 'Mount Prospect', region: 'Illinois', country: 'USA', email: 'lpeshek7320@stu.d214.org', lat: 42.0553, lng: -87.9279 },
  ...
  { name: 'Art4Hearts Palmetto Bay', leader: 'Leah Tavarez', location: 'Palmetto Bay', region: 'Florida', country: 'USA', email: 'Leahtavarez19@gmail.com', lat: 25.6609, lng: -80.2667 },
  { name: 'Art4Hearts Shenendehowa High School', leader: 'Sarah Desbiens', location: 'Clifton Park', region: 'New York', country: 'USA', email: 'smdesbiens26@gmail.com', lat: 42.8500, lng: -73.7667 },
  { name: 'Art4Hearts Cab Calloway School Of The Arts', leader: 'Kayla Otto', location: 'Wilmington', region: 'Delaware', country: 'USA', email: 'art4heartsccsa@gmail.com', lat: 39.1584, lng: -75.5244 },
  { name: 'Art4Hearts Huntington, NY', leader: 'Lea Davis', location: 'Huntington', region: 'New York', country: 'USA', email: 'art4heartshuntington@gmail.com', lat: 40.8619, lng: -73.4267 },
  { name: 'Art4Hearts Elite Scholars Academy', leader: 'Cassandra Gardner', location: 'Jonesboro', region: 'Georgia', country: 'USA', email: 'art4heartsesa@gmail.com', lat: 33.8343, lng: -84.3645 },
  { name: 'Art4Hearts Florence High School', leader: 'Shaniyah Bailey', location: 'Florence', region: 'Alabama', country: 'USA', email: 'mayweather1547@gmail.com', lat: 34.1899, lng: -87.6772 },
  { name: 'Art4Hearts Communications High School', leader: 'Vicky Zheng', location: 'Wall Township', region: 'New Jersey', country: 'USA', email: 'vickyjadezheng@gmail.com', lat: 40.1717, lng: -74.1698 },
  { name: 'Art4Hearts Berkley High School', leader: 'Sophia Nelson', location: 'Berkley', region: 'Michigan', country: 'USA', email: 'brknelsons44@stu.berkleyschools.org', lat: 42.4870, lng: -83.2143 },
  { name: 'Art4Hearts Piscataway High School', leader: 'Ayesha Rafique', location: 'Piscataway', region: 'New Jersey', country: 'USA', email: 'rafiqueayesha248@gmail.com', lat: 40.5556, lng: -74.4626 },
